...
class CTDL_Loader {
	...
	public static function check_for_upgrade() {
		...
		$exit_msg = esc_html__( 'To-Do List requires WordPress 3.3 or newer. <a href="http://codex.wordpress.org/Upgrading_WordPress">Please update.</a>', 'cleverness-to-do-list' );
	...
	private static function call_wp_hooks() {
		...
		add_action( 'wp_ajax_ctdl_display_todos', array( 'CTDL_Lib', 'display_todos_callback' ) );
	}
	...
	public static function frontend_checklist_add_js() {
		...
		if ( !$CTDL_Frontend_Checklist->add_script && !$CTDL_Frontend_Admin->add_script ) return;
