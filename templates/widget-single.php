<li<?php echo esc_html( ctdl_priority_class() ); ?>>
	...
	<?php if ( ctdl_check_field( 'widget-deadline' ) ) : ?>
		<br />
		<span class="deadline">
			<?php echo apply_filters( 'ctdl_deadline', esc_html__( 'Deadline', 'cleverness-to-do-list' ) ); ?>:
			<?php echo esc_html( ctdl_deadline() ); ?>
		</span>
	<?php endif; ?>
	...
	<?php if ( ctdl_check_field( 'widget-assigned' ) ) : ?>
		<br />
		<span class="assigned">
			<?php echo apply_filters( 'ctdl_assigned', esc_html__( 'Assigned to', 'cleverness-to-do-list' ) ); ?>
			<?php echo esc_html( ctdl_assigned() ); ?>
		</span>
	<?php endif; ?>
